;; Merge module that returns a GuestError (tag=0xFF) with error code 7.
;; The host must treat this as a run() failure, which the Merge impl
;; degrades to MergeResult::Miss.
(module
