;; Merge module that loops forever. The host's epoch deadline must
;; trap the guest within a bounded number of ticks; the Merge impl
;; degrades that trap to MergeResult::Miss.
(module
  ...
  (func (export "mcgw_merge") (param $ptr i32) (param $count i32) (result i64)
    ;; Tight loop; no side effects, no exit condition.
    (loop $busy (br $busy))
    unreachable))
